...
┌──────────┐          ┌──────────────────────────┐
│ 1 Docker │    →     │ 100+ Conteneurs          │
│ Container│          │ Sur plusieurs serveurs   │
...
│ Cloud Foundry, OpenShift, Docker Cloud, Deis    │
├─────────────────────────────────────────────────┤
│ Layer 5: Orchestration/Scheduling               │
│ Kubernetes, Docker Swarm, Marathon/Mesos, Nomad │
├─────────────────────────────────────────────────┤
│ Layer 4: Container Engine                       │
│ Docker, rkt, runC (OCI), Osv, LXC, LXD, CRIO   │
├─────────────────────────────────────────────────┤
